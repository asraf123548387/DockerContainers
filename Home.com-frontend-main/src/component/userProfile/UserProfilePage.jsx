...
const handleSaveAddress = () => {
  ...
  axios.defaults.headers.common['Authorization'] = `Bearer ${token}`;
  axios.put(`http://localhost:8080/user/profile/updateAddress`,{address:newAddress,id:userId})
  .then(response => {
    // Handle success response from the backend
...
const handleSaveDateOfBirth = () => {
  ...
  axios.defaults.headers.common['Authorization'] = `Bearer ${token}`;
  axios.put(`http://localhost:8080/user/profile/updateDateOfBirth`,{dateOfBirth:newDateOfBirth,id:userId})
  .then(response => {
    // Handle success response from the backend
    console.log('address successfully');
